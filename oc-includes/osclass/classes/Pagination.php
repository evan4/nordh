 ...
 */
    ...
    class Pagination
    {
        ...
        public function __construct($params = null)
        {
            ...
            $this->class_first        = isset($params['class_first']) ? $params['class_first'] : 'paginate__first';
            $this->class_last         = isset($params['class_last']) ? $params['class_last'] : 'paginate__last';
            $this->class_prev         = isset($params['class_prev']) ? $params['class_prev'] : 'paginate__prev';
            $this->class_next         = isset($params['class_next']) ? $params['class_next'] : 'paginate__next';
            $this->text_first         = isset($params['text_first']) ? $params['text_first'] : '<i class="fa fa-backward" aria-hidden="true"></i>';
            $this->text_last          = isset($params['text_last']) ? $params['text_last'] : '<i class="fa fa-forward" aria-hidden="true"></i>';
            $this->text_prev          = isset($params['text_prev']) ? $params['text_prev'] : '<i class="fa fa-chevron-left" aria-hidden="true"></i>';
            $this->text_next          = isset($params['text_next']) ? $params['text_next'] : '<i class="fa fa-chevron-right" aria-hidden="true"></i>';
            $this->class_selected     = isset($params['class_selected']) ? $params['class_selected'] : 'paginate__item paginate__item_active';
            $this->class_non_selected = isset($params['class_non_selected']) ? $params['class_non_selected'] : 'paginate__item';
            $this->delimiter          = isset($params['delimiter']) ? $params['delimiter'] : " ";
            $this->force_limits       = false;
