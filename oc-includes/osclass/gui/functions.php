...
<script type="text/javascript">
    ...
    function theme_bender_actions_admin() {
        //if(OC_ADMIN)
        if( Params::getParam('file') == 'oc-content/themes/bender/admin/residential_complex.php' ) {
        ...
        switch( Params::getParam('action_specific') ) {
            case('settings'):
                ...
                osc_redirect_to(osc_admin_render_theme_url('oc-content/themes/bender/admin/residential_complex.php'));
            break;
            case('upload_logo'):
    ...
    osc_admin_menu_appearance(__('Theme settings', 'bender'), osc_admin_render_theme_url('oc-content/themes/bender/admin/residential_complex.php'), 'settings_bender');
/**
