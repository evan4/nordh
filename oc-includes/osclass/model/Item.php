 ...
 */
    ...
    class Item extends DAO
    {
        ...
        // LEAVE THIS FOR COMPATIBILITIES ISSUES (ONLY SITEMAP GENERATOR)
        // BUT REMEMBER TO DELETE IN ANYTHING > 2.1.x THANKS
        public function listLatestPagintion($limit = 10)
        {
            return $this->listWhere(" b_active = 1 AND b_enabled = 1 ORDER BY dt_pub_date DESC LIMIT %d", (int)$limit);
        }

        public function listLatestPagintionC($limit = 10, $offset= 1,  $orderby = 'dt_pub_date', $dir = 'DESC')
        {
            return $this->listWhereC(" b_active = 1 AND b_enabled = 1 ORDER BY ".$orderby." ".$dir." LIMIT %d OFFSET %d", (int)$limit, (int)$offset);
        }
