    ...
    Class ItemActions
    {
        ...
        public function add()
        {
            ...
            if ($flash_error) {
                ...
                if(!Params::getParam("idItem")){
                    $aItem['idItem'] = null;
                }else{
                    $aItem['idItem'] = Params::getParam("idItem");
                }
                if(!Params::getParam("dt_pub_date")){
                    $aItem['dt_pub_date'] = date('Y-m-d H:i:s');
                }else{
                    $aItem['dt_pub_date'] = Params::getParam("dt_pub_date");
                }
                if(!Params::getParam("dt_pub_date")){
                    $aItem['dt_mod_date'] = null;
                }else{
                    $aItem['dt_mod_date'] = Params::getParam("dt_mod_date");
                }

                $this->manager->insert(array(
                    'pk_i_id'               => $aItem['idItem'],
                    'fk_i_user_id'          => $aItem['userId'],
                    'dt_pub_date'           => $aItem['dt_pub_date'],
                    'dt_mod_date'           => $aItem['dt_mod_date'],
        ...
        function edit() {
            ...
            if(Params::getParam("s_secret")){
                $aItem['secret'] = Params::getParam("s_secret");
            }
            if(!Params::getParam("dt_pub_date")){
                $aItem['dt_pub_date'] = date('Y-m-d H:i:s');
            }else{
