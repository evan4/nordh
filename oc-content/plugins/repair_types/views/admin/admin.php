...
$menu = Models_Types_Repair::newInstance()->getMenu();
?>
<link rel="stylesheet"
      href="<?php echo osc_base_url(); ?>/oc-content/plugins/repair_types/assets/css/libs/bootstrap.css">
<link rel="stylesheet"
      href="<?php echo osc_base_url(); ?>/oc-content/plugins/repair_types/assets/css/libs/toastr.min.css">
<style>
    input.form-control{
...
<script src="<?php echo osc_base_url(); ?>oc-content/plugins/repair_types/assets/js/libs/toastr.min.js"></script>
<script>
    //here we hold some usefull info for easy access
    var mySiteAdmin = window.mySiteAdmin || {};

    mySiteAdmin.ajax_add_url = '<?php echo osc_ajax_plugin_url('repair_types/helpers/menu_add_ajax.php'); ?>';
    mySiteAdmin.ajax_update_url = '<?php echo osc_ajax_plugin_url('repair_types/helpers/menu_edit_ajax.php'); ?>';
    mySiteAdmin.ajax_delete_url = '<?php echo osc_ajax_plugin_url('repair_types/helpers/menu_delete_ajax.php'); ?>';
    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="" method="post" id="filter-form-add"
                ...
                <div class="form-group" id="filter-form-wrap">
                    <label for="description_list">Список (каждый пункт с новой строки)</label>
                    <textarea name="description_list" id="description_list"
                              class="form-control" rows="3"
                              required></textarea>
                </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <form action="" method="post" id="filter-form_edit" class="collapse">
                ...
                <div class="form-group" id="filter-form-wrap">
                    <label for="description_edit">Краткое описание</label>
                    <textarea name="description" id="description_edit"
                              class="form-control" rows="3"
                              required></textarea>
                </div>
                <div class="form-group" id="filter-form-wrap">
                    <label for="description_edit_list">Список (каждый пункт с новой строки)</label>
                    <textarea name="description_list" id="description_edit_list"
                              class="form-control" rows="3"
                              required></textarea>
                </div>
                <div class="form-group" id="filter-form-wrap">
...
<script src="<?php echo osc_base_url(); ?>oc-content/plugins/repair_types/assets/js//main_menu.js"></script>
