...
$districts = Models_Districts::newInstance()->getByCityId(409054);
?>
<link rel="stylesheet"
...
<script>
    ...
    mySiteAdmin.ajax_add_url = '<?php echo osc_ajax_plugin_url('filter_search/helpers/districts/filter_ajax.php'); ?>';
    mySiteAdmin.ajax_get_url = '<?php echo osc_ajax_plugin_url('filter_search/helpers/districts/filter_ajax_get.php'); ?>';
    mySiteAdmin.ajax_update_url = '<?php echo osc_ajax_plugin_url('filter_search/helpers/districts/filter_edit_ajax.php'); ?>';
    mySiteAdmin.ajax_delete_url = '<?php echo osc_ajax_plugin_url('filter_search/helpers/districts/filter_delete_ajax.php'); ?>';
...
<div id="general-setting">
    ...
    <h2 class="render-title"><b>Районы</b></h2>
    ...
    <button id="add-district" class="btn btn-primary">Добавить район</button>
