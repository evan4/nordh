...
?>
<link rel="stylesheet"
      href="<?php echo osc_base_url(); ?>/oc-content/plugins/main_menu_repair/assets/css/libs/bootstrap.css">
<link rel="stylesheet"
      href="<?php echo osc_base_url(); ?>/oc-content/plugins/main_menu_repair/assets/css/libs/toastr.min.css">

<link rel="stylesheet"
      href="<?php echo osc_base_url(); ?>/oc-content/plugins/main_menu_repair/assets/css/main_menu.css">

<script src="<?php echo osc_base_url(); ?>oc-content/plugins/main_menu_repair/assets/js/libs/toastr.min.js"></script>
<script>
    //here we hold some usefull info for easy access
    var mySiteAdmin = window.mySiteAdmin || {};

    mySiteAdmin.ajax_add_url = '<?php echo osc_ajax_plugin_url('main_menu_repair/helpers/menu_add_ajax.php'); ?>';
    mySiteAdmin.ajax_update_url = '<?php echo osc_ajax_plugin_url('main_menu_repair/helpers/menu_edit_ajax.php'); ?>';
    mySiteAdmin.ajax_delete_url = '<?php echo osc_ajax_plugin_url('main_menu_repair/helpers/menu_delete_ajax.php'); ?>';
