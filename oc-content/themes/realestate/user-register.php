...
<div class="content-item">
    <div class="content user_forms">
        <div class="ui-generic-form ui-center single-form">
            <h1 class="caption caption_page"><?php _e('Register an account for free', 'realestate'); ?></h1>
            <ul id="error_list"></ul>
            <div class="ui-generic-form-content">
                <form name="register" id="register" action="<?php echo osc_base_url(true) ; ?>" method="post" >
                    ...
                    <fieldset>
                        <div class="row ui-row-text"><label for="name">Имя и фамилия</label> <?php UserForm::name_text(); ?></div>
                        <div class="row ui-row-text"><label for="tel">Телефон</label> <?php UserForm::mobile_text(); ?></div>
